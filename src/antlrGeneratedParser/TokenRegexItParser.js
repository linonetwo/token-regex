...
TokenRegexContext.prototype.tokenRegexBlock = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
TokenRegexItParser.prototype.tokenRegex = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << TokenRegexItParser.T__2) | (1 << TokenRegexItParser.T__4) | (1 << TokenRegexItParser.STRING))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
